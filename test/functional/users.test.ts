...
describe('Users functional tests', () => {
  ...
  describe('When creating a new user', () => {
    it('should succssfully create a new user with encrypted password', async () => {
      const newUser = {
        name: 'John Doe',
        email: 'john@mail.com',
        password: '1234',
  ...
  describe('When authenticationg a user', () => {
    ...
    it('Should return UNAUTHRIZER if user with the given email is not found', async () => {
      const response = await global.testRequest
        .post('/users/authenticate')
